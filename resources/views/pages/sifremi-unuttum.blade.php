...
<div class="solKatman">
    ...
    <div class="sSekmegiris">
    <div class="sSekmegirisol">E-Posta</div>
    <div class="sSekmegirisag">
    ...
    <div class="sSekmegirisag">
    <input type="submit" name="submit" value="Yeni Şifre Gönder"/>
    </div>
    ...
    <div class="uyeGirisanasagkay"><a href="/uye-ol.html" title="Üye Ol">Giriş Yap</a></div>
    <div class="uyeGirisanasagsif"><a href="/sifremi-unuttum.html" title="Şifremi Unuttum">Üye Ol</a></div>
    </div>
    </div>
    <div class="temizle"></div>
    </div>
